  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-600">Sube tus datos en formato Excel o CSV para comenzar el proceso de anonimización</p>
      </div>
          ...
          <div className="flex-1">
            ...
            <div className="space-y-3 text-sm text-slate-700">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-2">
                  <li><strong>Identificadores:</strong> ID, email, nombre completo, SSN (se eliminarán)</li>
                  <li><strong>Cuasi-identificadores:</strong> edad, código postal, género (se generalizarán)</li>
        ...
        {loading ? (
          ...
          <div className="grid gap-4">
            {datasets.map((dataset) => (
              <div key={dataset.id} className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                  ...
                  <thead>
                    <tr className="bg-slate-50">
                      {previewData.column_names.map((col, idx) => (
                        <th key={idx} className="px-4 py-2 text-left text-sm font-semibold text-slate-700 border border-slate-200">
                          {col}
                        </th>
                      ))}
                    </tr>
